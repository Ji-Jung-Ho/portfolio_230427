...
import './css/tablet_project01.css';

export default function TabletProject01Component () {
  ...
  return (
    <div id='tablet-project01'>
      <header id="header">
        <div className="container">
          <div className="btn-box">
            <button className='back-btn' onClick={onClickBtn}>
              <img src={img1} alt="back-btn-img"/>
            </button>
          </div>
        ...
        <div className="container">
          ...
          <div className="project-content">
            <div className="project-info">
              <h2>❗프로젝트 설명</h2>
              <p className='project-info-main-title'>다양한 식재료와 생활용품을 판매하는 온라인 쇼핑몰 <strong>마켓컬리</strong> 홈페이지를 클론 코딩하여 본 사이트의 기능을 최대한 구현했습니다.</p>
              <p className='project-info-sub-title'><strong>마켓컬리</strong> 팀 프로젝트에서 구현한 핵심 기능은 <span>3가지</span>입니다.</p>
              <ul>
            ...
            <div className="development-part">
              <h2 className='development-main-title'>❗프로젝트에서 맡은 부분</h2>
              <ul>
              ...
              <br />
              <ul>
                <li className='detail-part'>- 베스트, 특가/혜택 페이지의 UI를 구현하였으며, AJAX를 사용하여 JSON 데이터(상품 이미지)를 추가했습니다.<br /> </li>
                <li className='detail-part'>- 회원가입에서 아이디와 이메일의 중복확인을 위해 PHP 조회문을 만들어 DB에 저장된 아이디와 이메일을 비교할 수 있게 구현했습니다. <br /></li>
                <li className='detail-part'>- Modal, Header를 제작하면서 페이지 이동, Scroll, Tool-Tip 이벤트를 구현했습니다. <br /></li>
                <li className='detail-part'>- 회원가입 주소 검색 기능을 구현하기 위해 Daum 주소 API를 활용했고, 주소 팝업창도 구현하여 Daum 주소 API에서 주소를 입력하면 팝업창에서 나머지 주소를 입력할 수 있게 구현했습니다. <br /></li>
                <li className='detail-part'>- 회원가입 시 유효성검사를 해서 필수입력사항이 모두 입력되어야 회원가입을 할 수 있게 구현했습니다.</li>
              </ul>
            </div>
            <div className="experience">
              <h2 className='experience-main-title'>❗성장 경험</h2>
              <h2 className='experience-sub-title'><span>HTML, CSS로 쇼핑몰 웹페이지 구성과 디자인 이해</span></h2>
              <p>
              ...
              <h2 className='experience-sub-title'><span>JavaScript와 jQuery, PHP를 활용한 동적인 페이지 개발</span></h2>
              <p>
              ...
              <h2 className='experience-sub-title'><span>팀원들과의 협업</span></h2>
                <p>
