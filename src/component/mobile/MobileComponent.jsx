          ...
          <article className='sec2-article'>
            <div className="about-me">
              ...
              <div className="about-row-box">
                <div className="row1-left row1">
                  <div className="name my-info">
                  ...
                  <div className="info">
                    ...
                    <div className="development-info">
                      ...
                      <div className='detail'>
                        ...
                        <p className='right-p'>HTML,&nbsp;CSS,&nbsp;javascript, <br/>jQuery</p>
                      </div>
                      <div className='detail'>
                ...
                <div className="project-info-02">
                  ...
                  <div className="info">
                    ...
                    <div className="development-info">
                      ...
                      <div className='detail'>
                        <p className='left-p'><span>🔺</span>Frontend :</p>
                        <p className='right-p'>HTML,&nbsp;CSS,&nbsp;javascript,<br/>jQuery&nbsp;React</p>
                      </div>
                      <div className='detail'>
                        <p className='left-p'><span>🔺</span>Backend :</p>
                        <p className='right-p'>PHP,&nbsp;Node.js</p>
                      ...
                      <div className='detail'>
                        <p className='left-p'><span>🔺</span>배포 :</p>
                        <p className='right-p'>gh-page를 사용하여 GitHub 홈페이지 배포</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="project-info-03">
                  ...
                  <div className="info">
                    ...
                    <div className="development-info">
                      ...
                      <div className='detail'>
                        <p className='left-p'><span>🔺</span>Frontend :</p>
                        <p className='right-p'>HTML,&nbsp;CSS,&nbsp;Javascript,<br/>React</p>
                      </div>
                      <div className='detail'>
                        <p className='left-p'><span>🔺</span>Backend :</p>
