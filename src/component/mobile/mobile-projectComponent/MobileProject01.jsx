...
export default function Mobilemobile_project01 () {
        ...
        <div className="container">
          ...
          <div className="project-content">
            <div className="project-info">
              ...
              <p className='project-info-sub-title'><strong>마켓컬리</strong> 팀 프로젝트에서 구현한 핵심 기능은 <br /><span>3가지</span>입니다.</p>
              <ul>
