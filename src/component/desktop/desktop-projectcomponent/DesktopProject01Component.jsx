...
import './css/desktop_project01.css';

export default function DesktopProject01Component () {
        ...
        <div className="container">
          ...
          <div className="project-content">
            ...
            <div className="experience">
              ...
              <p>
                <span>마켓컬리</span> 홈페이지는 클론 코딩이여서 기획을 많이 하지는 않았지만, 쇼핑몰 홈페이지의 기본적인 구성을 알게되었습니다.<br />
